...
export const ACCORDION_ITEM_CONTAINER_ATTR: string = `data-${PREFIX}-accordion-item`;
export const ACCORDION_ITEM_CONTAINER_SELECTOR: string = `[${ACCORDION_ITEM_CONTAINER_ATTR}]`;
